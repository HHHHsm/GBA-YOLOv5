...
source_pic_root_path = r'D:\DYJ\99\images\train/'  # 原图所在文件夹路径
source_xml_root_path = r'D:\DYJ\99\labels\train-xml/'  # 原XML文件所在文件夹路径
img_save_path = r'D:\DYJ\99Z\images\train/'  # 新图片存储路径
save_dir = r'D:\DYJ\99Z\labels\train/'  # 新xml存储路径
# 如果保存文件夹不存在就创建
